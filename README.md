...
| **Patients** | Searchable list, full profile, photo upload, cascade delete |
| **New Visit** | Tap-to-select services, price overrides, discount, autocomplete, offline save |
...
| **Bookings** | Inbound appointment requests from public site, Accept/Reject/Reschedule, WhatsApp confirmation |
...
| **Offline** | Full app loads from cache, visits queued in IndexedDB, auto-sync on reconnect |
...
│   ├── visits.js           # Visit form — online and offline save
...
3. **Administrators** onboard new staff and send magic links via the Admin Portal (Tier 3)
4. **All tiers** share the same Supabase project — appointments are the cross-cutting data entity
